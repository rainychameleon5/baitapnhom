...
input_display.grid(row=0, column=0, columnspan=5, padx=5, pady=(5, 0), ipady=20)

result_display = tk.Entry(root, font=("Arial", 24), borderwidth=2, relief="ridge", justify="right")
result_display.grid(row=1, column=0, columnspan=5, padx=5, pady=(0, 5), ipady=20)

# Thêm chữ "máy" và "tính"
tk.Label(root, text="NHÓM", font=("Arial", 18)).grid(row=5, column=2, padx=5, pady=5, sticky="nsew")
tk.Label(root, text="12", font=("Arial", 18)).grid(row=6, column=2, padx=5, pady=5, sticky="nsew")
...
buttons = [
                    ('←', 3, 1),            ('→', 3, 3),
    ('log', 4, 0), ('^', 4, 1), ('!', 4, 2), ('%', 4, 3), ('π', 4, 4),
    ('ln', 5, 0), ('√', 5, 1),             ('sin', 5, 3), ('cos', 5, 4),
    ('e', 6, 0), ('(', 6, 1),              (')', 6, 3), ('tan', 6, 4),
    ('7', 7, 0), ('8', 7, 1), ('9', 7, 2), ('Del', 7, 3), ('C', 7, 4),
    ('4', 8, 0), ('5', 8, 1), ('6', 8, 2), ('*', 8, 3), ('/', 8, 4),
    ('1', 9, 0), ('2', 9, 1), ('3', 9, 2), ('+', 9, 3), ('-', 9, 4),
    ('0', 10, 0), ('.', 10, 1), ('*10^', 10, 2), ('Ans', 10, 3), ('=', 10, 4)
]
...
# Thêm nút Thoát kéo dài 5 cột
tk.Button(root, text="Thoát", width=5, height=1, font=("Arial", 18), command=root.quit).grid(
    row=11, column=0, columnspan=5, padx=5, pady=5, sticky="nsew"
)
